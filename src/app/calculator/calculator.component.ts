...
export class CalculatorComponent implements OnInit {
  ...
  //convertir gramos de producto elegido a otras medidas
  calculate() {
    console.log(this.selected)
    let gramosValue = parseInt(this.gramos.nativeElement.value)//obtener datos de gramos
